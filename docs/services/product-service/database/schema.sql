-- =============================================================================
-- product-service - Consolidated PostgreSQL schema
...
-- Notes:
-- 1. Service logic treats code and slug uniqueness as tenant-scoped, but the
--    current physical schema enforces them globally via UNIQUE constraints.
-- 2. processed_events is provisioned for future consumer-side idempotency only.
