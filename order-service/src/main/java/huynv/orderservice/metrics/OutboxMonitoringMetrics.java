package huynv.orderservice.metrics;
...
public class OutboxMonitoringMetrics {
    ...
    /**
     * Creates an outbox monitoring metrics publisher for order-service.
     *
     ...
     */
    @Scheduled(fixedDelayString = "${outbox.metrics.interval-ms:15000}")
    public void refreshOldestAge() {
        OffsetDateTime oldestCreatedAt = outboxEventRepository.findOldestUnsentCreatedAt();
