...
/**
 * Provides transactional boundaries for claiming and updating product outbox rows.
 */
@Service
public class ProductOutboxTransactionalService {

    private final OutboxEventRepository outboxEventRepository;

    /**
     * Creates an outbox transactional service used by outbox publisher workers.
     *
     * @param outboxEventRepository repository used for outbox persistence operations.
     * @return initializes an outbox transactional service.
     */
    public ProductOutboxTransactionalService(OutboxEventRepository outboxEventRepository) {
