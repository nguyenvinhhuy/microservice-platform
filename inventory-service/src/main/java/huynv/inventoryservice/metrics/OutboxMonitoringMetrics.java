package huynv.inventoryservice.metrics;
...
public class OutboxMonitoringMetrics {
    ...
    /**
     * Creates an outbox monitoring metrics publisher for inventory-service.
     *
     ...
     */
    @Scheduled(fixedDelayString = "${inventory.outbox.metrics.interval-ms:15000}")
