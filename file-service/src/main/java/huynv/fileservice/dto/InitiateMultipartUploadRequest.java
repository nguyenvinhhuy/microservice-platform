...
/**
 * Describes the client request used to initiate a multipart upload session.
 *
 ...
 * @param checksumSha256 Expected full-object SHA-256 checksum in lowercase hexadecimal form.
 ...
 * @return Returns an immutable request payload for multipart upload initiation.
 */
