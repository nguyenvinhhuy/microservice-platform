...
/**
 * Configures JWT-based authentication and authorization for user-service.
 */
@Configuration
...
public class SecurityConfig {
    ...
    public SecurityFilterChain actuatorSecurityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/actuator/health/liveness", "/actuator/prometheus").permitAll()
                        .requestMatchers("/actuator/health/readiness", "/actuator/info")
    ...
    /**
     * Configures the main application security chain for public and internal user-service APIs.
     *
     * @param http Spring Security HTTP configuration builder.
     ...
     */
    private AuthorizationDecision internalAuthorizationDecision(org.springframework.security.core.Authentication authentication) {
